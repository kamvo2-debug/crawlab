...
const updateLogsFn = (isEnd: boolean) => {
  return async () => {
    ...
    // update pagination if auto update is enabled
    if (isEnd) {
...
const updateLogs = updateLogsFn(false);
const updateLogsEnd = updateLogsFn(true);
